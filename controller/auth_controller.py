...
def create_email_template(user_name: str, verification_link: str, email: str, phone: str) -> str:
    """
    Renders the HTML email template using Jinja2.

    Args:
        user_name (str): The name of the user to personalize the email.
        verification_link (str): The verification link to include in the email.
...
async def send_welcome_email(user: UserAddDTO, verification_link: str):
    """
    Sends a welcome email with user personalization and verification link.

    Args:
        user_email (EmailStr): The email address of the registered user.
        user_name (str): The name of the registered user.
        verification_link (str): The verification link to include in the email.
    """
